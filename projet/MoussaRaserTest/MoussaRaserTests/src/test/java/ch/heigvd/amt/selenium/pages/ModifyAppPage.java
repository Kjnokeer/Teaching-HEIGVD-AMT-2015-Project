...
public class ModifyAppPage extends AbstractMoussaRaserPage{    
    ...
    public ModifyAppPage typeName(String name) {
        driver.findElement(tfNameLocator).sendKeys(name);
        return this;
    }
    public ModifyAppPage typeDescription(String description) {
    ...
    public Page submitForm(Class<? extends Page> expectedPageClass) {
        ...
        try {
            ...
            Logger.getLogger(ModifyAppPage.class.getName()).log(Level.SEVERE, null, ex);
