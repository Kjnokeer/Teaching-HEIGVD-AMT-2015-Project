...
<html lang="en">
  ...
  <body>
    ...
    <div class="container content">
		<div class="picture_post row">
			<div class="row post_header">
				<div class="col-md-2 picture_post_header">
					<img class="avatar img-responsive img-circle" src="img/users/UnsafeDriving/avatar.ico" />
				</div>
				<div class="col-md-10 username_post_header">
					<a>UnsafeDriving</a>
				</div>
			</div>
			<hr>
			<div class="row">
				<div class="col-md-12 img-responsive picture_post_content">
